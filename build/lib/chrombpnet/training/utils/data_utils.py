...
# def load_data(bed_regions, nonpeak_regions, genome_fasta, cts_bw_file_atac, cts_bw_file_dnase, inputlen, outputlen, max_jitter):
#     """
#     Load sequences and corresponding base resolution counts for training,
#     validation regions in peaks and nonpeaks (2 x 2 x 2 = 8 matrices).
#
...
#     """
#
#     cts_bw_atac = pyBigWig.open(cts_bw_file_atac)
#     cts_bw_dnase = pyBigWig.open(cts_bw_file_dnase)
#     genome = pyfaidx.Fasta(genome_fasta)
#
#     train_peaks_seqs=None
#     train_peaks_cts=None
...
#
#     if bed_regions is not None:
#         train_peaks_seqs, train_peaks_cts_atac, train_peaks_coords = get_seq_cts_coords(bed_regions,
#                                               genome,
#                                               cts_bw_atac,
#                                               inputlen+2*max_jitter,
#                                               outputlen+2*max_jitter,
#                                               peaks_bool=1)
#         _, train_peaks_cts_dnase, _ = get_seq_cts_coords(bed_regions,
#                                               genome,
#                                               cts_bw_dnase,
#                                               inputlen+2*max_jitter,
#                                               outputlen+2*max_jitter,
...
#
#     if nonpeak_regions is not None:
#         train_nonpeaks_seqs, train_nonpeaks_cts_atac, train_nonpeaks_coords = get_seq_cts_coords(nonpeak_regions,
#                                               genome,
#                                               cts_bw_atac,
#                                               inputlen,
#                                               outputlen,
#                                               peaks_bool=0)
#         _, train_nonpeaks_cts_dnase, _ = get_seq_cts_coords(nonpeak_regions,
#                                               genome,
#                                               cts_bw_dnase,
#                                               inputlen,
#                                               outputlen,
...
#     genome.close()
#
#     return (train_peaks_seqs, train_peaks_cts_atac, train_peaks_cts_dnase, train_peaks_coords,
#             train_nonpeaks_seqs, train_nonpeaks_cts_atac, train_nonpeaks_cts_dnase, train_nonpeaks_coords)
