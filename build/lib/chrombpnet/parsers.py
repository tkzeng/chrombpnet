...
def read_parser():
        ...
        def general_training_args(required_train, optional_train):
                ...
                #group.add_argument('-ibam', '--input-bam-file-atac', type=str, help="Input BAM file")
                #group.add_argument('-ifrag', '--input-fragment-file-atac', type=str, help="Input fragment file")
                #group.add_argument('-itag', '--input-tagalign-file-atac', type=str, help="Input tagAlign file")
                required_train.add_argument('-ibw_atac', '--input-bigwig-file-atac', type=str, help="Input bigwig file")
                required_train.add_argument('-ibw_dnase', '--input-bigwig-file-dnase', type=str, help="Input bigwig file")
                ...
                required_train.add_argument("-p_atac", "--peaks-atac", type=str, required=True, help="10 column bed file of peaks. Sequences and labels will be extracted centered at start (2nd col) + summit (10th col).")
                required_train.add_argument("-p_dnase", "--peaks-dnase", type=str, required=True, help="10 column bed file of peaks. Sequences and labels will be extracted centered at start (2nd col) + summit (10th col).")
                required_train.add_argument("-n_atac", "--nonpeaks-atac", type=str, required=True, help="10 column bed file of non-peak regions, centered at summit (10th column)")
                required_train.add_argument("-n_dnase", "--nonpeaks-dnase", type=str, required=True, help="10 column bed file of non-peak regions, centered at summit (10th column)")
        ...
        required_main_parser.add_argument("-atac_b", "--atac-bias-model-path", type=str, required=True, help="Path for a pretrained ATAC bias model")
        required_main_parser.add_argument("-dnase_b", "--dnase-bias-model-path", type=str, required=True, help="Path for a pretrained DNASE bias model")
        ...
        #required_pipeline_parser.add_argument("-atac_b", "--atac-bias-model-path", type=str, required=True, help="Path for a pretrained ATAC bias model")
        #required_pipeline_parser.add_argument("-dnase_b", "--dnase-bias-model-path", type=str, required=True, help="Path for a pretrained DNASE bias model")
       ...
       # bias model qc arguments
        ...
        optional_preds.add_argument("-bw_dnase", "--bigwig_dnase", type=str, default=None, help="If provided .h5 with predictions are output along with calculated metrics considering bigwig as groundtruth.")
        optional_preds.add_argument("-bw_atac", "--bigwig_atac", type=str, default=None)
