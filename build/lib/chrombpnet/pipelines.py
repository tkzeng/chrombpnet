...
def chrombpnet_train_pipeline(args):
	...
	args_copy = copy.deepcopy(args)
	args_copy.bigwig = args.input_bigwig_file_atac
	args_copy.peaks = args.peaks_atac
	args_copy.nonpeaks = args.nonpeaks_atac
	args_copy.output_prefix = os.path.join(args.output_dir,"auxiliary/{}atac_".format(fpx))
	find_chrombpnet_hyperparams.main(args_copy)
	args_copy.bigwig = args.input_bigwig_file_dnase
	args_copy.peaks = args.peaks_dnase
	args_copy.nonpeaks = args.nonpeaks_dnase
	args_copy.output_prefix = os.path.join(args.output_dir,"auxiliary/{}dnase_".format(fpx))
	find_chrombpnet_hyperparams.main(args_copy)
	...
	os.rename(os.path.join(args.output_dir,"auxiliary/{}atac_chrombpnet_model_params.tsv".format(fpx)),
			  os.path.join(args.output_dir,"logs/{}atac_chrombpnet_model_params.tsv".format(fpx)))
	os.rename(os.path.join(args.output_dir,"auxiliary/{}atac_chrombpnet_data_params.tsv".format(fpx)),
			  os.path.join(args.output_dir,"logs/{}atac_chrombpnet_data_params.tsv".format(fpx)))
	os.rename(os.path.join(args.output_dir,"auxiliary/{}dnase_chrombpnet_model_params.tsv".format(fpx)),
			  os.path.join(args.output_dir,"logs/{}dnase_chrombpnet_model_params.tsv".format(fpx)))
	os.rename(os.path.join(args.output_dir,"auxiliary/{}dnase_chrombpnet_data_params.tsv".format(fpx)),
			  os.path.join(args.output_dir,"logs/{}dnase_chrombpnet_data_params.tsv".format(fpx)))

	#params = open(os.path.join(args.output_dir,"logs/{}atac_chrombpnet_model_params.tsv".format(fpx))).read()
	...
	args_copy.atac_peaks = os.path.join(args.output_dir,"auxiliary/{}filtered_atac.peaks.bed".format(fpx))
	args_copy.atac_nonpeaks = os.path.join(args.output_dir,"auxiliary/{}filtered_atac.nonpeaks.bed".format(fpx))
	args_copy.dnase_peaks = os.path.join(args.output_dir,"auxiliary/{}filtered_dnase.peaks.bed".format(fpx))
	args_copy.dnase_nonpeaks = os.path.join(args.output_dir,"auxiliary/{}filtered_dnase.nonpeaks.bed".format(fpx))
	args_copy.output_prefix = os.path.join(args.output_dir,"models/{}chrombpnet".format(fpx))
	# looks like only this parameter is used: counts_loss_weight
	args_copy.params = os.path.join(args.output_dir,"logs/{}dnase_chrombpnet_model_params.tsv".format(fpx))
